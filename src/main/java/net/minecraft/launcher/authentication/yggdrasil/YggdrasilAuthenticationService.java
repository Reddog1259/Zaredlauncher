...
public class YggdrasilAuthenticationService extends BaseAuthenticationService {
    private static final String BASE_URL = LauncherConstants.URL_AUTHENTICATION_SERVER;
    private static final URL ROUTE_AUTHENTICATE = Util.constantURL(LauncherConstants.URL_AUTHENTICATION_SERVER + "authenticate");
    private static final URL ROUTE_REFRESH = Util.constantURL(LauncherConstants.URL_AUTHENTICATION_SERVER + "refresh");
    private static final URL ROUTE_VALIDATE = Util.constantURL(LauncherConstants.URL_AUTHENTICATION_SERVER + "validate");
    private static final URL ROUTE_INVALIDATE = Util.constantURL(LauncherConstants.URL_AUTHENTICATION_SERVER + "invalidate");
    private static final URL ROUTE_SIGNOUT = Util.constantURL(LauncherConstants.URL_AUTHENTICATION_SERVER + "signout");
