...
public class PlayerInfoPanel extends JPanel implements RefreshedProfilesListener, RefreshedVersionsListener {
    ...
    public void checkState() {
        ...
        if(auth == null || !auth.isLoggedIn()) {
            ...
            Skin skin = new Skin();
            try{
            getLauncher().getLauncherPanel().pseudotxt.setText(auth.getSelectedProfile().getName());
            getLauncher().getLauncherPanel().skinviewer.remove(getLauncher().getLauncherPanel().leskin);
            getLauncher().getLauncherPanel().leskin=skin.viewer(auth.getSelectedProfile().getName());
            getLauncher().getLauncherPanel().skinviewer.add(getLauncher().getLauncherPanel().leskin);
            getLauncher().getLauncherPanel().skinviewer.repaint();
            }catch (Exception e){
